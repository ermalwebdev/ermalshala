...
const linksHeaderMenu = function (orderList, position) {
  if (window.innerWidth <= 400) {
    headerLinks[orderList].addEventListener("click", function () {
      if (myMenu.classList.contains("showMenu")) {
        myMenu.classList.remove("showMenu");
        menuClose.style.display = "none";
        menuOpen.style.display = "block";
        headerLinks[orderList].addEventListener(
          "click",
          window.scrollTo({
            top: position,
            behavior: "smooth",
...
headerLinks[0].addEventListener("click", function () {
  linksHeaderMenu(0, 43);
});
headerLinks[1].addEventListener("click", function () {
  linksHeaderMenu(1, 377);
});
headerLinks[2].addEventListener("click", function () {
  linksHeaderMenu(2, 471);
});
headerLinks[3].addEventListener("click", function () {
  linksHeaderMenu(3, 1886);
});
window.onscroll = function () {
